  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.filterRow}>
        <TouchableOpacity
          style={[styles.filterBtn, sport === null && styles.filterBtnActive]}
        ...
        <TouchableOpacity
          style={[
            styles.filterBtn,
            styles.filterBtnRow,
            sport === 'padel' && styles.filterBtnActive,
          ]}
          onPress={() => setSport('padel')}
        >
          <PadelIcon size={13} color={sport === 'padel' ? colors.white : colors.ink500} />
          <Text style={[styles.filterText, sport === 'padel' && styles.filterTextActive]}>
            Pádel
          </Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={[
            styles.filterBtn,
            styles.filterBtnRow,
            sport === 'pickleball' && styles.filterBtnActive,
          ]}
          onPress={() => setSport('pickleball')}
        >
          <PickleballIcon size={13} color={sport === 'pickleball' ? colors.white : colors.ink500} />
          <Text style={[styles.filterText, sport === 'pickleball' && styles.filterTextActive]}>
            Pickleball
          </Text>
        </TouchableOpacity>
      </View>
        ...
        <FlatList
                ...
                <View style={styles.clubInfo}>
                  ...
                  {(item as any).recentlyBooked && (
                    <View style={styles.recentTagRow}>
                      <Ionicons name="time-outline" size={12} color={colors.court600} />
                  ...
                  <View style={styles.sportTags}>
                    {item.sports.map((s) => (
                      <Badge
                        key={s}
                        tone={s === 'padel' ? 'emerald' : 'amber'}
                        icon={
                          <SportIcon
                            sport={s}
                            size={11}
                            color={s === 'padel' ? colors.court700 : colors.trophy700}
                          />
                        }
                      >
                        {sportLabel(s)}
                ...
                <View style={styles.clubMeta}>
                  {item.ratingAvg > 0 && (
                    <View style={styles.ratingRow}>
                      <Ionicons name="star" size={12} color={colors.trophy500} />
          ...
          ListEmptyComponent={
            <EmptyState
              ...
              description="Intenta con otra ciudad o deporte"
            />
          }
        />
      )}
...
const styles = StyleSheet.create({
  ...
  headerSub: { color: colors.court300, fontSize: fontSize.sm, marginTop: 2 },
  myBookingsBtn: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: spacing.xs,
  ...
  filterBtnActive: { backgroundColor: colors.court600 },
  filterText: { fontSize: fontSize.sm, color: colors.ink500, fontWeight: '500' },
  ...
  clubCity: { fontSize: fontSize.sm, color: colors.ink500, marginTop: 2 },
  ...
  courtsCount: { fontSize: fontSize.xs, color: colors.court600, fontWeight: '600' },
})
