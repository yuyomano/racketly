...
const ZERO_DECIMAL = new Set([
  'JPY', 'KRW', 'IDR', 'VND', 'CLP', 'PYG', 'COP', 'MXN',
  'ARS', 'HUF', 'ISK', 'UGX', 'XOF', 'XAF', 'CRC', 'GTQ',
])
...
const FX_TO_USD: Record<string, number> = {
  ...
  CAD: 0.73,    AUD: 0.65,    NZD: 0.60,    SGD: 0.74,
  JPY: 0.0066,  CNY: 0.138,   KRW: 0.00073, HKD: 0.128,
  INR: 0.012,   THB: 0.028,   MYR: 0.215,   IDR: 0.000062,
  PHP: 0.0174,  VND: 0.000039,TWD: 0.031,
  MXN: 0.057,   COP: 0.000238,ARS: 0.00098, BRL: 0.18,
  CLP: 0.00105, PEN: 0.265,   UYU: 0.025,   BOB: 0.145,
  DOP: 0.017,   CRC: 0.00193, GTQ: 0.129,   HNL: 0.04,
  PYG: 0.000135,
  AED: 0.272,   SAR: 0.267,   QAR: 0.274,   KWD: 3.25,
  BHD: 2.65,    OMR: 2.60,    ILS: 0.272,   TRY: 0.031,
  ZAR: 0.054,   NGN: 0.00063, EGP: 0.02,    MAD: 0.098,
  KES: 0.0077,  GHS: 0.063,
}
...
export function pctTrend(curr: number, prev: number): { trend: string; trendUp: boolean } | undefined {
