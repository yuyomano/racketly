...
import { makeAttachUser } from './middleware/auth.middleware'
...
// Implementación en ./middleware/auth.middleware — extraída para poder testear
// la lógica de verificación/anti-suplantación sin levantar el servidor entero.
app.use(makeAttachUser(JWT_SECRET))
